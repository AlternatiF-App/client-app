...
export default class ListStudents extends Component {
    ...
    onUp = () => {
        ...
        this.state.idStudents.map((item,index=0) => {
            ...
            // updateDataId.push(item)
            // updateDataClus.push(this.state.clustersStudents[index]) 
            params = {
                "id": item,
                "cluster": this.state.clustersStudents[index]
            }
            updateDataId.push(params)
        })
        console.log('cok', updateDataId)
        ...
        const fetchUpdate = {
            ...
            body:JSON.stringify(updateDataId)
        } 
